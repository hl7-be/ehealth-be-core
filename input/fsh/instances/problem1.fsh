...
* extension.url = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-ext-problem-origin-type"
...
* bodySite.extension.url = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-ext-laterality"

...
* meta.profile[0] = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-medicationdispense"
* language = #fr-BE
...
* medicationCodeableConcept.coding.system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/cnk-codes"

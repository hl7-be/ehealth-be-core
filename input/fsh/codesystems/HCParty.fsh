...
* #deptanatomopathology ^designation[0].language = #en
* #deptanatomopathology ^designation[=].value = "anatomopathology"
* #deptanatomopathology ^designation[+].language = #nl-BE
* #deptanatomopathology ^designation[=].value = "anatomo-pathologie"
* #deptanatomopathology ^designation[+].language = #fr-BE
...
* #deptanesthesiology ^designation[0].language = #en
...
* #deptanesthesiology ^designation[+].language = #fr-BE
...
* #deptbacteriology ^designation[0].language = #en
...
* #deptbacteriology ^designation[+].language = #fr-BE
...
* #deptcardiology ^designation[0].language = #en
...
* #deptemergency ^designation[+].language = #fr-BE
...
* #deptgastroenterology ^designation[0].language = #en
...
* #deptgastroenterology ^designation[+].language = #fr-BE
...
* #deptgeneralpractice ^designation[0].language = #en
...
* #deptgeneralpractice ^designation[+].language = #fr-BE
...
* #deptgynecology ^designation[+].language = #fr-BE
...
* #depthematology ^designation[0].language = #en
...
* #depthematology ^designation[+].language = #fr-BE
...
* #deptintensivecare ^designation[0].language = #en
* #deptintensivecare ^designation[=].value = "intensive care"
* #deptintensivecare ^designation[+].language = #nl-BE
* #deptintensivecare ^designation[=].value = "intensieve zorgen"
* #deptintensivecare ^designation[+].language = #fr-BE
...
* #deptkinesitherapy "kinesitherapy"
* #deptkinesitherapy ^designation[0].language = #en
* #deptkinesitherapy ^designation[=].value = "kinesitherapy"
* #deptkinesitherapy ^designation[+].language = #nl-BE
* #deptkinesitherapy ^designation[=].value = "kinesitherapie"
* #deptkinesitherapy ^designation[+].language = #fr-BE
...
* #deptlaboratory ^designation[0].language = #en
...
* #deptlaboratory ^designation[+].language = #fr-BE
...
* #deptlaboratory ^designation[=].value = "Laboratorium Dienst/Abteilung in einer Organisation"
* #deptmedicine "internal medecine"
* #deptmedicine ^designation[0].language = #en
...
* #deptmedicine ^designation[+].language = #fr-BE
...
* #deptmolecularbiology ^designation[0].language = #en
...
* #deptmolecularbiology ^designation[+].language = #fr-BE
...
* #deptneonatalogy ^designation[0].language = #en
...
* #deptnephrology ^designation[+].language = #fr-BE
...
* #deptneurology ^designation[0].language = #en
...
* #deptneurology ^designation[+].language = #fr-BE
* #deptneurology ^designation[=].value = "neurologie"
* #deptneurology ^designation[+].language = #de
* #deptneurology ^designation[=].value = "Neurologie"
* #deptnte "nose-throat-ear"
* #deptnte ^designation[0].language = #en
...
* #deptnte ^designation[+].language = #fr-BE
* #deptnte ^designation[=].value = "oto-rhino-laryngologie"
* #deptnte ^designation[+].language = #de
* #deptnte ^designation[=].value = "Otorhinolaryngologie"
* #deptnuclear "nuclear"
* #deptnuclear ^designation[0].language = #en
* #deptnuclear ^designation[=].value = "nuclear"
* #deptnuclear ^designation[+].language = #nl-BE
* #deptnuclear ^designation[=].value = "nucleaire geneeskunde"
* #deptnuclear ^designation[+].language = #fr-BE
...
* #deptophtalmology ^designation[+].language = #fr-BE
...
* #deptpharmacy ^designation[0].language = #en
...
* #deptpharmacy ^designation[+].language = #fr-BE
...
* #deptpharmacy ^designation[=].value = "Pharmazie Dienst/Abteilung in einer Organisation"
* #deptphysiotherapy "physiotherapy"
* #deptphysiotherapy ^designation[0].language = #en
...
* #deptphysiotherapy ^designation[+].language = #fr-BE
...
* #deptpsychiatry ^designation[+].language = #fr-BE
* #deptpsychiatry ^designation[=].value = "psychiatrie"
* #deptpsychiatry ^designation[+].language = #de
* #deptpsychiatry ^designation[=].value = "Psychiatrie"
* #deptradiology "radiology"
* #deptradiology ^designation[0].language = #en
...
* #deptradiology ^designation[+].language = #fr-BE
* #deptradiology ^designation[=].value = "radiologie"
* #deptradiology ^designation[+].language = #de
* #deptradiology ^designation[=].value = "Radiologie"
* #deptradiotherapy "radiotherapy"
* #deptradiotherapy ^designation[0].language = #en
...
* #deptradiotherapy ^designation[+].language = #fr-BE
...
* #deptstomatology ^designation[0].language = #en
...
* #orginsurance ^designation[0].language = #en
...
* #orginsurance ^designation[+].language = #fr-BE
...
* #orglaboratory ^designation[0].language = #en
...
* #orglaboratory ^designation[+].language = #fr-BE
...
* #orgpublichealth ^designation[0].language = #en
...
* #orgpublichealth ^designation[+].language = #fr-BE
...
* #persbiologist ^designation[0].language = #en
...
* #persbiologist ^designation[+].language = #fr-BE
...
* #perspharmacist ^designation[0].language = #en
...
* #perssocialworker ^designation[0].language = #en
...
* #perssocialworker ^designation[+].language = #fr-BE
...
* #perstechnician ^designation[0].language = #en
...
* #perstechnician ^designation[+].language = #fr-BE
* #perstechnician ^designation[=].value = "Technicien d'imagerie médicale"
* #perstechnician ^designation[+].language = #de
* #perstechnician ^designation[=].value = "medizinische Bildgebung Techniker"
* #persadministrative "administrative"
* #persadministrative ^designation[0].language = #en
* #persadministrative ^designation[=].value = "administrative"
* #persadministrative ^designation[+].language = #nl-BE
* #persadministrative ^designation[=].value = "administratieve medewerker"
* #persadministrative ^designation[+].language = #fr-BE
* #persadministrative ^designation[=].value = "personnel admistratif"
* #persadministrative ^designation[+].language = #de
* #persadministrative ^designation[=].value = "Büroangestellte(r)"
* #persmidwife "midwife"
* #persmidwife ^designation[0].language = #en
* #persmidwife ^designation[=].value = "midwife"
* #persmidwife ^designation[+].language = #nl-BE
* #persmidwife ^designation[=].value = "vroedvrouw"
* #persmidwife ^designation[+].language = #fr-BE
* #persmidwife ^designation[=].value = "sage-femme"
* #persmidwife ^designation[+].language = #de
* #persmidwife ^designation[=].value = "Hebamme"
* #application "software application"
* #application ^designation[0].language = #en
...
* #application ^designation[+].language = #fr-BE
...
* #deptorthopedy ^designation[0].language = #en
...
* #deptorthopedy ^designation[+].language = #fr-BE
...
* #orgpractice "practice organisation"
* #orgpractice ^designation[0].language = #en
* #orgpractice ^designation[=].value = "practice organisation"
* #orgpractice ^designation[+].language = #nl-BE
* #orgpractice ^designation[=].value = "praktijk"
* #orgpractice ^designation[+].language = #fr-BE
...
* #orgpharmacy ^designation[0].language = #en
...
* #orgpharmacy ^designation[+].language = #fr-BE
...
* #deptcardiacsurgery ^designation[+].language = #fr-BE
...
* #depthandsurgery ^designation[0].language = #en
...
* #depthandsurgery ^designation[+].language = #fr-BE
...
* #deptmaxillofacialsurgery ^designation[0].language = #en
...
* #deptmaxillofacialsurgery ^designation[+].language = #fr-BE
...
* #deptpediatricsurgery ^designation[0].language = #en
...
* #deptpediatricsurgery ^designation[+].language = #fr-BE
...
* #deptplasticandreparatorysurgery ^designation[0].language = #en
...
* #deptplasticandreparatorysurgery ^designation[+].language = #fr-BE
...
* #deptplasticandreparatorysurgery ^designation[=].value = "plastische Chirurgie und Reparaturchirurgie"
* #deptthoracicsurgery "thoracic surgery"
* #deptthoracicsurgery ^designation[0].language = #en
...
* #deptthoracicsurgery ^designation[+].language = #fr-BE
...
* #deptvascularsurgery ^designation[0].language = #en
...
* #deptvascularsurgery ^designation[+].language = #fr-BE
...
* #deptvisceraldigestiveabdominalsurgery ^designation[0].language = #en
...
* #deptvisceraldigestiveabdominalsurgery ^designation[+].language = #fr-BE
...
* #deptvisceraldigestiveabdominalsurgery ^designation[=].value = "Viszeralchirurgie/Abdominalchirurgie/Bauchchirurgie"
* #deptdentistry "dentistry"
* #deptdentistry ^designation[0].language = #en
...
* #deptdentistry ^designation[+].language = #fr-BE
...
* #deptdiabetology ^designation[0].language = #en
...
* #deptendocrinology ^designation[+].language = #fr-BE
...
* #deptoccupationaltherapy ^designation[0].language = #en
...
* #deptoccupationaltherapy ^designation[+].language = #fr-BE
* #deptoccupationaltherapy ^designation[=].value = "ergothérapie"
* #deptoccupationaltherapy ^designation[+].language = #de
* #deptoccupationaltherapy ^designation[=].value = "Ergotherapie"
* #deptmajorburns "major burns"
* #deptmajorburns ^designation[0].language = #en
* #deptmajorburns ^designation[=].value = "major burns"
* #deptmajorburns ^designation[+].language = #nl-BE
* #deptmajorburns ^designation[=].value = "brandwondencentrum"
* #deptmajorburns ^designation[+].language = #fr-BE
* #deptmajorburns ^designation[=].value = "grands brûlés"
* #deptmajorburns ^designation[+].language = #de
* #deptmajorburns ^designation[=].value = "Zentrum für Schwerbrandverletzte"
* #deptinfectiousdisease "infectious disease"
* #deptinfectiousdisease ^designation[0].language = #en
...
* #deptinfectiousdisease ^designation[+].language = #fr-BE
...
* #deptspeechtherapy ^designation[0].language = #en
...
* #deptspeechtherapy ^designation[+].language = #fr-BE
...
* #deptsportsmedecine ^designation[0].language = #en
...
* #deptsportsmedecine ^designation[+].language = #fr-BE
...
* #deptphysicalmedecine ^designation[0].language = #en
...
* #deptphysicalmedecine ^designation[+].language = #fr-BE
...
* #depttropicalmedecine ^designation[0].language = #en
...
* #depttropicalmedecine ^designation[+].language = #fr-BE
...
* #deptneurosurgery "neuro surgery"
* #deptneurosurgery ^designation[0].language = #en
* #deptneurosurgery ^designation[=].value = "neuro surgery"
* #deptneurosurgery ^designation[+].language = #nl-BE
* #deptneurosurgery ^designation[=].value = "neurologie"
* #deptneurosurgery ^designation[+].language = #fr-BE
* #deptneurosurgery ^designation[=].value = "neurologie"
* #deptneurosurgery ^designation[+].language = #de
* #deptneurosurgery ^designation[=].value = "Neurologie"
* #deptnutritiondietetics "nutrition dietetics"
* #deptnutritiondietetics ^designation[0].language = #en
* #deptnutritiondietetics ^designation[=].value = "nutrition dietetics"
* #deptnutritiondietetics ^designation[+].language = #nl-BE
* #deptnutritiondietetics ^designation[=].value = "diëtetiek"
* #deptnutritiondietetics ^designation[+].language = #fr-BE
* #deptnutritiondietetics ^designation[=].value = "diététique nutritionnelle"
* #deptnutritiondietetics ^designation[+].language = #de
* #deptnutritiondietetics ^designation[=].value = "Diätetik"
* #deptobstetrics "obstetrics"
* #deptobstetrics ^designation[0].language = #en
...
* #deptobstetrics ^designation[+].language = #fr-BE
...
* #deptchildandadolescentpsychiatry ^designation[0].language = #en
...
* #deptchildandadolescentpsychiatry ^designation[+].language = #fr-BE
...
* #deptpsychology ^designation[+].language = #fr-BE
* #deptpsychology ^designation[=].value = "psychologie"
* #deptpsychology ^designation[+].language = #de
* #deptpsychology ^designation[=].value = "Psychologie"
* #deptrevalidation "revalidation"
* #deptrevalidation ^designation[0].language = #en
...
* #deptrevalidation ^designation[+].language = #fr-BE
...
* #deptsocialservice ^designation[+].language = #fr-BE
...
* #deptpediatricintensivecare ^designation[0].language = #en
...
* #deptpediatricintensivecare ^designation[+].language = #fr-BE
...
* #deptpediatricintensivecare ^designation[=].value = "Intensivpflege für Kinder"
* #deptpalliativecare "palliative care"
* #deptpalliativecare ^designation[0].language = #en
...
* #deptpalliativecare ^designation[+].language = #fr-BE
* #deptpalliativecare ^designation[=].value = "soins palliatifs"
* #deptpalliativecare ^designation[+].language = #de
* #deptpalliativecare ^designation[=].value = "Palliativpflege"
* #deptrheumatology "rheumatology"
* #deptrheumatology ^designation[0].language = #en
...
* #deptrheumatology ^designation[+].language = #fr-BE
...
* #persambulancefirstaid ^designation[0].language = #en
...
* #persambulancefirstaid ^designation[+].language = #fr-BE
...
* #persaudiologist ^designation[+].language = #fr-BE
...
* #perscaregiver ^designation[0].language = #en
...
* #perscaregiver ^designation[+].language = #fr-BE
...
* #perscaregiver ^property.code = #status
* #perscaregiver ^property.valueCode = #deprecated
* #persdietician "dietician"
* #persdietician ^designation[0].language = #en
* #persdietician ^designation[=].value = "dietician"
* #persdietician ^designation[+].language = #nl-BE
* #persdietician ^designation[=].value = "dietist"
* #persdietician ^designation[+].language = #fr-BE
...
* #persoccupationaltherapist ^designation[0].language = #en
...
* #persoccupationaltherapist ^designation[+].language = #fr-BE
...
* #perspharmacyassistant ^designation[+].language = #fr-BE
* #perspharmacyassistant ^designation[=].value = "assistant en pharmacie"
* #perspharmacyassistant ^designation[+].language = #de
* #perspharmacyassistant ^designation[=].value = "Apothekenhelfer"
* #persphysiotherapist "physiotherapist"
* #persphysiotherapist ^designation[0].language = #en
...
* #perspracticalnurse ^designation[0].language = #en
...
* #perspracticalnurse ^designation[+].language = #fr-BE
...
* #perspsychologist ^designation[0].language = #en
...
* #perspsychologist ^designation[+].language = #fr-BE
...
* #orgprimaryhealthcarecenter ^designation[0].language = #en
...
* #orgprimaryhealthcarecenter ^designation[+].language = #fr-BE
...
* #guardpost ^designation[0].language = #en
* #guardpost ^designation[=].value = "Guard post"
* #guardpost ^designation[+].language = #nl-BE
* #guardpost ^designation[=].value = "wachtpost"
* #guardpost ^designation[+].language = #fr-BE
...
* #groupofphysicianssameaddress ^designation[0].language = #en
...
* #groupofphysicianssameaddress ^designation[+].language = #fr-BE
...
* #groupofphysiciansdifferentaddress ^designation[0].language = #en
...
* #groupofphysiciansdifferentaddress ^designation[+].language = #fr-BE
...
* #groupofnurses ^designation[0].language = #en
...
* #groupofnurses ^designation[+].language = #fr-BE
...
* #certificateholder ^designation[0].language = #en
...
* #certificateholder ^designation[+].language = #fr-BE
...
* #persorthotist ^designation[+].language = #fr-BE
...
* #perspatientdriver ^designation[0].language = #en
...
* #perspatientdriver ^designation[+].language = #fr-BE
...
* #orgprevention "Prevention organisation"
* #orgprevention ^designation[0].language = #en
* #orgprevention ^designation[=].value = "Prevention organisation"
* #orgprevention ^designation[+].language = #nl-BE
* #orgprevention ^designation[=].value = "Preventiedienst"
* #orgprevention ^designation[+].language = #fr-BE
* #orgprevention ^designation[=].value = "Service de pévention"
...
* #perspharmacistclinicalbiologist ^designation[0].language = #en
...
* #perspharmacistclinicalbiologist ^designation[+].language = #fr-BE
...
* #perspharmacistclinicalbiologist ^designation[=].value = "Apotheker-klinische Biologe"
* #hub "hub"
* #hub ^designation[0].language = #en
* #hub ^designation[=].value = "hub"
* #hub ^designation[+].language = #nl-BE
* #hub ^designation[=].value = "hub"
* #hub ^designation[+].language = #fr-BE
* #hub ^designation[=].value = "hub"
* #hub ^designation[+].language = #de
* #hub ^designation[=].value = "hub"
* #deptnursing "nursing"
* #deptnursing ^designation[0].language = #en
* #deptnursing ^designation[=].value = "nursing"
* #deptnursing ^designation[+].language = #nl-BE
* #deptnursing ^designation[=].value = "verpleegkunde"
* #deptnursing ^designation[+].language = #fr-BE
...
* #persoraldentalhygienist ^designation[0].language = #en
...
* #persoraldentalhygienist ^designation[+].language = #fr-BE
...
* #persclinicalpsychologist ^designation[0].language = #en
...
* #persclinicalpsychologist ^designation[+].language = #fr-BE
...
* #persclinicalorthopedagogist ^designation[0].language = #en
...
* #persclinicalorthopedagogist ^designation[+].language = #fr-BE
* #persclinicalorthopedagogist ^designation[=].value = "Orthopédagogue clinicien"
...
* #orgretirementhome "retirementhome"
* #orgretirementhome ^designation[0].language = #en
* #orgretirementhome ^designation[=].value = "retirementhome"
* #orgretirementhome ^designation[+].language = #nl-BE
* #orgretirementhome ^designation[=].value = "woonzorgcentrum"
* #orgretirementhome ^designation[+].language = #fr-BE
* #orgretirementhome ^designation[=].value = "maison de repos"
* #orgretirementhome ^designation[+].language = #de
* #orgretirementhome ^designation[=].value = "Altenheim"
* #orgrevalidationcenter "revalidation center"
* #orgrevalidationcenter ^designation[0].language = #en
...
* #orgrevalidationcenter ^designation[+].language = #fr-BE
* #orgrevalidationcenter ^designation[=].value = "centre de revalidation"
* #orgrevalidationcenter ^designation[+].language = #de
* #orgrevalidationcenter ^designation[=].value = "Unfallkrankenhaus"
* #orgshelteredliving "sheltered living"
* #orgshelteredliving ^designation[0].language = #en
...
* #orgpsychiatriccarehome ^designation[+].language = #fr-BE
